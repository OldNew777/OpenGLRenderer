//
// Created by ChenXin on 2022/10/4.
//
    ...
    [[nodiscard]] constexpr auto pixel_storage_to_format(PixelStorage storage) noexcept {
        if constexpr (std::is_same_v<T, float>) {
            switch (storage) {
                ...
                default: GL_RENDER_ERROR_WITH_LOCATION("Invalid pixel storage for float format.");
            }
            ...
            switch (storage) {
                ...
                default: GL_RENDER_ERROR_WITH_LOCATION("Invalid pixel storage for int format.");
            }
            ...
            switch (storage) {
                ...
                default: GL_RENDER_ERROR_WITH_LOCATION("Invalid pixel storage for uint format.");
            }
        } else {
